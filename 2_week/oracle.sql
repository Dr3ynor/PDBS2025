...
exec PrintPages_unused_space('CUSTOMER', 'KRA28', 'TABLE');
exec PrintPages_space_usage('CUSTOMER', 'KRA28', 'TABLE');

exec PrintPages_unused_space('SYS_C00552552', 'KRA28', 'INDEX');
exec PrintPages_space_usage('SYS_C00552552', 'KRA28', 'INDEX');
